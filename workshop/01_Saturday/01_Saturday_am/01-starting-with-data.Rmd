...
Notice this time that we've added `row.names=1` to tell R that the first column represents row names.

```{r}
dat <- read.csv('data/inflammation-02.csv', header=TRUE, row.names=1)
```
